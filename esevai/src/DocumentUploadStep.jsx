...
const DocumentUploadStep = ({ uploadedImages, handleImageUpload, removeImage, goToPreviousStep, handleReviewSubmit }) => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md mb-8">
      ...
      <p className="text-gray-600 mb-6">Please upload relevant land documents (Max 400KB each)</p>
          ...
          <table className="w-full border-collapse border border-gray-300">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border border-gray-300 px-4 py-2 text-left">Attachment (Maximum Size - 400KB)</th>
      ...
      <div className="flex justify-between">
        ...
        <button
          onClick={handleReviewSubmit} // Now goes to review step, not final submit
